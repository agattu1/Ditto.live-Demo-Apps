...
class MainActivity : AppCompatActivity(), DittoManager.ItemUpdateListener {
    ...
    private lateinit var totalTextView: TextView  // Add this

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_main)

        // Initialize total text view
        totalTextView = findViewById(R.id.totalTextView)  // Add this
    ...
    private fun updateTotalPrice() {
        ...
        val total = DittoManager.itemsForView.sumOf { it.count * it.price }
        ...
        // Color coding
        when {
            total > 80.0 -> totalTextView.setTextColor(ContextCompat.getColor(this, R.color.colorTotalRed))
            total > 55.0 -> totalTextView.setTextColor(ContextCompat.getColor(this, R.color.colorTotalYellow))
            else -> totalTextView.setTextColor(ContextCompat.getColor(this, R.color.colorTotalGreen))
        }
    }
